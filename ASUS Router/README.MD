...
RECORD_ID="bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb" # curl -H "Authorization: Bearer ${APIKEY_CLOUDFLARE}" "https://api.cloudflare.com/client/v4/zones/${ZONE_ID}/dns_records" | json_pp
